...
/**
 * Tests whether the indices for the threads are calculated correctly with the primitive strategy
 */
TEST(LinkedCellContainer, IndicesThreadVectorPrimitiveStrategyTest) {
	std::array<LinkedCellContainer::Border, 6> bor{};
	bor.fill(LinkedCellContainer::periodic);
	// max dimension is x
	LinkedCellContainer linkedCellContainer1 =
		LinkedCellContainer{4, 2, 2, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveX};
	...
	// max dimension ix y
	LinkedCellContainer linkedCellContainer2 =
		LinkedCellContainer{2, 4, 2, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveY};
	...
	// max dimension is z
	LinkedCellContainer linkedCellContainer3 =
		LinkedCellContainer{2, 2, 4, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveZ};
	...
	// Now in 2D
	// max dimension is x
	LinkedCellContainer linkedCellContainer4 =
		LinkedCellContainer{4, 2, 1, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveX};
	...
	// Now in 2D
	// max dimension is y
	LinkedCellContainer linkedCellContainer5 =
		LinkedCellContainer{2, 4, 1, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveY};
	...
	// Uneven dimension
	LinkedCellContainer linkedCellContainer6 =
		LinkedCellContainer{5, 2, 2, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveX};
	...
	LinkedCellContainer linkedCellContainer7 =
		LinkedCellContainer{5, 3, 4, 1., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveZ};
	...
	LinkedCellContainer linkedCellContainer8 =
		LinkedCellContainer{120, 120, 13, 4., bor, {0, 0, 0}, LinkedCellContainer::Strategy::primitiveZ};
 ...
 */
TEST(LinkedCellContainer, SubDomainIndicesTest) {
	std::array<LinkedCellContainer::Border, 6> bor{};
	bor.fill(LinkedCellContainer::periodic);
	...
	// max dimension is x
	LinkedCellContainer linkedCellContainer1 =
		LinkedCellContainer{11, 5, 0, 1., bor, {0., 0., 0.}, LinkedCellContainer::Strategy::subDomain};
