...
Particle::Particle(const Particle &other) : se_index{other.se_index}, type{other.type}, f{other.f}, old_f{other.old_f}, x{other.x}, v{other.v},
                                            m{other.m}, baseForce{other.baseForce}, gridIndex{other.gridIndex}, valid{other.valid},  immovable{other.immovable}, membrane{other.membrane} {
...
Particle::Particle(Particle &&other) noexcept: se_index{other.se_index}, type{other.type}, f{other.f}, old_f{other.old_f}, x{other.x}, v{other.v},
                                               m{other.m}, baseForce{other.baseForce}, gridIndex{other.gridIndex}, valid{true}, immovable{other.immovable}, membrane{other.membrane}{
    other.type = 0;
    other.f = {};
    other.old_f = {};
    other.x = {};
