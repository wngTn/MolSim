...
Particle::Particle() : se_index{0}, type{0}, f{std::array<double, 3>{}}, old_f(std::array<double, 3>{}), baseForce{0,0,0}, valid{true}, membrane{false} {
    spdlog::info("Particle generated with default constructor!");
}


Particle::Particle(int type_arg) : se_index{0}, type{type_arg}, f{std::array<double, 3>{}}, old_f(std::array<double, 3>{}), baseForce{0,0,0}, valid{true}, membrane{false} {
...
Particle::Particle(std::array<double, 3> x_arg, std::array<double, 3> v_arg,
                   double m_arg, int type_arg) : se_index{0}, type{type_arg}, f{std::array<double, 3>{}},
                                                 ...
                                                 x{x_arg}, v{v_arg}, m{m_arg},  baseForce{0,0,0}, valid{true}, membrane{false} {
...
Particle::Particle(const Particle &other) : se_index{other.se_index}, type{other.type}, f{other.f}, old_f{other.old_f}, x{other.x}, v{other.v},
                                            m{other.m}, baseForce{other.baseForce}, gridIndex{other.gridIndex}, valid{other.valid}, membrane{other.membrane} {
...
Particle::Particle(Particle &&other) noexcept: se_index{other.se_index}, type{other.type}, f{other.f}, old_f{other.old_f}, x{other.x}, v{other.v},
                                               m{other.m}, baseForce{other.baseForce}, gridIndex{other.gridIndex}, valid{true}, membrane{other.membrane}{
    other.type = 0;
    other.f = {};
    other.old_f = {};
    other.x = {};
